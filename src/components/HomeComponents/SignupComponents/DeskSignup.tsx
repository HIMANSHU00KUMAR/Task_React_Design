          ...
          <nav className="flex gap-5 justify-between w-full max-md:flex-wrap max-md:max-w-full">
            ...
            <div className="flex gap-4 text-base font-medium">
              ...
              <div className="flex gap-1 text-black">
                <Link to={"/signin"}><Button icon="https://cdn.builder.io/api/v1/image/assets/TEMP/18cd40d889ffef45625803768c78bf939f90e1573d3dbedc620fcc76909b41db?apiKey=240a3564ebc049d98414cf55e6ed763c&" className="bg-gray-100">
                  Write a Post
                </Button></Link>
