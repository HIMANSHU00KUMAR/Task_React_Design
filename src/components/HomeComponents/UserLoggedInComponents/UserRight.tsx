            ...
            <div className="mb-10">
                ...
                <div className="flex mt-5 ">
                    <div className="flex gap-3">
                        <img src="src/assets/Rectangle 6.png" alt="" className="shrink-0 aspect-square w-[28px]" />
                ...
                <div className="flex  mt-5">
                    <div className="flex gap-3">
                        <img src="src/assets/Rectangle 6 (1).png" alt="" className="shrink-0 aspect-square w-[28px]" />
                ...
                <div className="flex  mt-5">
                    <div className="flex gap-3">
                        <img src="src/assets/Rectangle 6 (2).png" alt="" className="shrink-0 aspect-square w-[28px]" />
                ...
                <div className="flex  mt-5 mb-10">
                    <div className="flex gap-3">
                        <img src="src/assets/Rectangle 6 (3).png" alt="" className="shrink-0 aspect-square w-[28px]" />
